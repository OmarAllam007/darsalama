...
import { doctors, home } from '@/routes';
...
const DEPT_ICONS = [
    ...
    >
        ...
        <path
            d="M5 12h3l1.4-2.8L11.5 13l1.3-2h4.2"
            strokeLinecap="round"
    ...
    >
        ...
        <path
            d="M12 9v3M8 21l2-7h4l2 7M7 15h10"
            strokeLinecap="round"
            strokeLinejoin="round"
        />
    </svg>,
...
const EMERGENCY_ICONS = [
    ...
    >
        <path
            d="M3 18v-6a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2M13 12h4a2 2 0 0 1 2 2v4"
            strokeLinecap="round"
        />
                ...
                <div className="container">
                    ...
                    <div className="dsm">
                        <div className="dept-grid">
                            {departments.map((d, i) => (
                                <article
                                    className="dept-card dept-card--upright"
                                    key={d.title}
                                >
                                    <div className="dc-media">
                                        <span className="dc-wm">
                                            {cloneElement(DEPT_ICONS[i], {
                                                width: 104,
                                                height: 104,
                                            })}
                                        </span>
                    ...
                    <div className="diagnostics-grid">
                        {diagnostics.map((d) => (
                            <div className="info-card" key={d.title}>
                                <div className="info-card__head">
                                    <h3>{d.title}</h3>
                                    <span className="info-card__icon info-card__icon--check">
                                        {CHECK}
                                    </span>
                                </div>
                                <p>{d.body}</p>
